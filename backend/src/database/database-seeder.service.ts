...
export class DatabaseSeederService implements OnApplicationBootstrap {
  ...
  private async seedFlightsAndSeats() {
    ...
    // Sembrar una reserva histórica de ejemplo para DV-204 asiento 11C
    ...
    this.logger.log('✓ Semilla completada: 4 vuelos, 720 asientos y reservas iniciales cargadas.');
  }
}
